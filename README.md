...
1. Clone the repository to your desktop or favorite directory (import it to your desktop)
copy the link HTTPS
<img width="883" alt="Capture d’écran 2022-12-04 à 10 20 08" src="https://user-images.githubusercontent.com/81431557/205472640-3e2baea0-8abe-4db6-a10c-725852831c46.png">

2. ``` cmd + space bar ``` write down ```terminal``` then press ```enter```
...
3. Copy the path of your desktop
<img width="502" alt="Capture d’écran 2022-12-04 à 10 23 17" src="https://user-images.githubusercontent.com/81431557/205472703-1e63865b-7edd-4a39-aac9-d870ae5f50ca.png">

4. Paste it into the terminal ```cd 'desktop/path' ``` then  press ```enter```, then ``` git clone link-of-1st-step``` then ```enter```
